return {{
    ...
    dependencies = {"nvim-treesitter/nvim-treesitter", "nvim-telescope/telescope.nvim", -- optional
    ...
    opts = {
        server = {
            ...
            end, -- callback executed when the language server gets attached to a buffer
